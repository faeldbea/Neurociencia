function [data] = Snowball(itera,data,screens,screenNumber,w,c1,c2,aparecio_H,letra_roja)
% DrawSomeText
%
...
%data =[aparecio_H, respuesta_H, tiempo_H, letra_roja, respuesta_roja, tiempo_roja, cantText1, cantText2, cantText3]
...
%     frame = 0.018;
    frame       = 0.016; % frame = Screen('GetFlipInterval',w);
    disp([Screen('GetFlipInterval',w) frame])
...
while 1
    ...
    Screen('DrawText', w, letras(3) , 900, 500, [255 0 0 255]);
    ...
    while a
        ...
        Screen('TextSize',w, 100);
        Screen('TextStyle', w, 1+2);
        Screen('DrawText', w, '¿Cual fue la letra roja?', 500, 450, [255, 255, 255, 255]);
        Screen('Flip',w);
        end
        if n==1
        tic 
        ...
        Screen('TextSize',w, 100);
        Screen('TextStyle', w, 1+2);
        Screen('DrawText', w, '¿Aparecio la H?', 500, 450, [255, 255, 255, 255]);
        Screen('DrawText', w, '( s/n )', 540, 550, [255, 255, 255, 255]);
        Screen('Flip',w);
        end
    ...
    Screen('TextSize',w, 100);
    Screen('TextStyle', w, 1+2);
    Screen('DrawText', w, '¿Estas listo?', 600, 450, [255, 255, 255, 255]);
    Screen('DrawText', w, '(Toca la barra dos veces)', 400, 550, [255, 255, 255, 255]);
    Screen('Flip',w);
    while toc<tiemp*3 %segundos
    end
    KbWait;     
